...
const TeamCard = ({name, title, stack, imagePath}) => {
  return (
    <div className='flex flex-col bg-white h-[18em] w-[15em] rounded-lg items-center pt-6 mx-6 my-2'>
        <img className='flex w-[10em] h-[10em]' src={imagePath} alt="example"/>
